...
export const Documentation: React.FC = () => {
      ...
      <div className="p-6 md:p-8 max-w-4xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#1e1056] p-4 rounded-lg border border-[#3d2a9e]">
              <h3 className="font-semibold text-[#a78bfa] mb-2">KEYWORD</h3>
              <p className="text-sm text-[#c4b5fd]">
                Palabras reservadas del lenguaje como int, if, while, for, etc.
              </p>
            </div>
            <div className="bg-[#0c2b1f] p-4 rounded-lg border border-[#065f46]">
            ...
            <div className="bg-[#1c1000] p-4 rounded-lg border border-[#78350f]">
            ...
            <div className="bg-[#2d0e1a] p-4 rounded-lg border border-[#831843]">
            ...
            <div className="bg-[#001526] p-4 rounded-lg border border-[#075985]">
            ...
            <div className="bg-[#181818] p-4 rounded-lg border border-[#334155]">
  ...
  return 0;
        ...
        <section className="bg-[#111b35] border border-[#284083] rounded-lg p-6">
